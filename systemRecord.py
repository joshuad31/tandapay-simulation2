...
class SystemRecord:
    def __init__(self, total_member_cnt):
        ...
        self.quit_cnt = 0                                # SysRec7:  Number of members that quit (init to 0) 
    ...
    @property
    def cur_moonth_individual_shortfall(self):
        return self._cur_moonth_individual_shortfall

    @cur_moonth_individual_shortfall.setter
    def cur_moonth_individual_shortfall(self, value):
        self._cur_moonth_individual_shortfall = value
